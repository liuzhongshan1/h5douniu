<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"C:\phpStudy\WWW\douniu/application/game\view\douniuplay\index.html";i:1504874127;s:67:"C:\phpStudy\WWW\douniu/application/game\view\douniuplaywjy\mp3.html";i:1502376220;s:67:"C:\phpStudy\WWW\douniu/application/game\view\douniuplaywjy\img.html";i:1500606572;}*/ ?>
<!DOCTYPE>
<html>
<head>
...
<style>
    body{background:url(__STATIC__/game/img/table.jpg) no-repeat; background-size: 100% auto;background-color: rgb(17, 103, 59);}
    .photo{display: none;}
    .msgshow{
        position: fixed;
        bottom:0;
    ...
    .cards .poker{width:16%; display: inline-block;}
...
<!-- 游戏准备按钮 -->
<img id="gameready" onclick="gameready1(1);" src="__STATIC__/game/img/ready2.png" style="position:absolute;top: 70%; left: 50%; z-index: 3; margin-left:-50px; width: 100px; <?php if($memberinfo['gamestatus'] == '1'): ?>display:none;<?php endif; ?>">
...
<div class="rules" style="display: none;">
    ...
    <div class="cons">
        ...
        <ul>
            ...
            <li>局数:<span>
<?php if($gamerule['gamenum'] == '12:1'): ?>
                12局x1房卡
<?php endif; if($gamerule['gamenum'] == '24:1'): ?>
                24局x2房卡
<?php endif; ?>
            </span></li>
        </ul>
...
<div class="container">
    <div class="header">
        ...
        <p class="round" style="width:100%;position: static;
    margin: 0;
    line-height: 2.8;
    text-align: center; position: static; margin: 0; text-align: center;"><span id="playcount"><?php echo $room['playcount']; ?></span>/<span><?php echo $gamenum; ?></span>&nbsp;局

<br>
        <span style="font-size: 14px;color: #fff;
    background: rgba(0,0,0,0.6);
    padding: 3px 9px;
    border-radius: 12px;">底注：<span><?php echo $gamerule['score']; ?></span>分</span>
        ...
        <div class="players1">
            <div class="photo" id="player_1">
                ...
                <div class="cardsbox" style="bottom:45px; right:85px;">
                    <div class="poker box1"><img class="pic1" src="__STATIC__/game/img/pai2/0.png"></div>
                    <div class="poker box2"><img class="pic2" src="__STATIC__/game/img/pai2/0.png"></div>
                    <div class="poker box3"><img class="pic3" src="__STATIC__/game/img/pai2/0.png"></div>
                    <div class="poker box4"><img class="pic4" src="__STATIC__/game/img/pai2/0.png"></div>
                    <div class="poker box5"><img class="pic5" src="__STATIC__/game/img/pai2/0.png"></div>
            ...
            <div class="photo" id="player_2">
                ...
                <div class="cardsbox" style="bottom:45px; right:85px;">
                    <div class="poker box1"><img class="pic1" src="__STATIC__/game/img/pai2/0.png"></div>
                    <div class="poker box2"><img class="pic3" src="__STATIC__/game/img/pai2/0.png"></div>
                    <div class="poker box3"><img class="pic4" src="__STATIC__/game/img/pai2/0.png"></div>
                    <div class="poker box4"><img class="pic5" src="__STATIC__/game/img/pai2/0.png"></div>
                    <div class="poker box5"><img class="pic5" src="__STATIC__/game/img/pai2/0.png"></div>
                    <div class="niuname">未知</div>
                    <div class="xiazhubox"><img class="bankerimg" src="__STATIC__/game/img/qiangzhuang.png"><img src="__STATIC__/game/img/X-1.png" class="multipleimg"> </div>
                </div>
    ...
    bottom: 100px;" class="readyimg" id="myreadyimg" src="__STATIC__/game/img/ready1.png" style="width: 2.5rem;height: 2.5rem;">
        ...
        <div class="cards">
            ...
            <img src="__STATIC__/game/img/tanpai.png" onclick="tanpai(); mp3play('mp3xiazhu');" class="tanpai" style="display:none">
            ...
            <div class="xiazhu" style="display: none; margin-top:12px;">
                ...
                <img onclick="setmultiple(4);" src="__STATIC__/game/img/4.png">
                <img onclick="setmultiple(5);" src="__STATIC__/game/img/five.png">
            </div>
            ...
            <div class="pai">
                ...
                <div class="poker box1" onclick="poker.ajaxshow('<?php echo url('showone'); ?>',0,'__STATIC__/game/img/pai2/',this,function(){ mp3play('mp3fapai');});"><img class="pk" src="__STATIC__/game/img/pai2/0.png"></div>
                <div class="poker box2" onclick="poker.ajaxshow('<?php echo url('showone'); ?>',1,'__STATIC__/game/img/pai2/',this,function(){ mp3play('mp3fapai');});"><img class="pk" src="__STATIC__/game/img/pai2/0.png"></div>
                <div class="poker box3" onclick="poker.ajaxshow('<?php echo url('showone'); ?>',2,'__STATIC__/game/img/pai2/',this,function(){ mp3play('mp3fapai');});"><img class="pk" src="__STATIC__/game/img/pai2/0.png"></div>
                <div class="poker box4" onclick="poker.ajaxshow('<?php echo url('showone'); ?>',3,'__STATIC__/game/img/pai2/',this,function(){ mp3play('mp3fapai');});"><img class="pk" src="__STATIC__/game/img/pai2/0.png"></div>
                <div class="poker box5" onclick="poker.ajaxshow('<?php echo url('showone'); ?>',4,'__STATIC__/game/img/pai2/',this,function(){ mp3play('mp3fapai');});"><img class="pk" src="__STATIC__/game/img/pai2/0.png"></div>
            </div><div class="niuname">未知</div>
        </div>
    </div>
    <div class="msg" id="player_99" style="bottom: 0;">
        <div class="photo member__<?php echo $memberinfo['id']; ?>" style="display: block; margin-bottom: 10px;">
            <img src="<?php echo $memberinfo['photo']; ?>" style="width: 2.8rem;height: 2.8rem;">
            <img class="zhuangimg" src="__STATIC__/game/img/zhuang.png">
...
<div style="clear: both;"></div>
        ...
        <div style="left: 0; width: 100%;" class="">
            <img src="__STATIC__/game/img/tb111.png" width="100%" style="position: absolute; left:0; z-index: -1;height: 3.2rem;">
            <img src="__STATIC__/game/img/roomCard.png"
                 style="width: 1.4em; float:left;margin:0.2rem 0 0 1rem;vertical-align: middle;"><span
                style="display: inline-block;padding:0.2rem 0.6rem 0.2rem 0.4rem;background:#564C4A;color: #eee;font-size: 0.7rem;line-height:1rem;border-top-right-radius: 0.9rem;border-bottom-right-radius: 0.9rem;border: 1px solid #666;vertical-align: bottom;margin-bottom: 0.4rem;float:left; margin-top:6px;"><span style="font-size: 0.7rem;" id="roomcards"><?php echo $room['room_cards_num']; ?></span>张</span>



            <div class="msg-action">

                <img src="__STATIC__/game/img/audiobtn.png" class="audiobtn">

                <img onclick="window.location.href='<?php echo url('myhome/index'); ?>'" src="__STATIC__/game/img/home.png" style="margin-right:20px;" class="home">

                <img src="__STATIC__/game/img/guize.png" class="rule">  <img class="inviteico" src="__STATIC__/game/img/invite.png" style=""> <img src="__STATIC__/game/img/xiaoxi.png" class="showmsgimg" style="width: 1.6rem;height: 1.6rem;" />
...
<script src="__STATIC__/js/pokershow.js?v=1.90"></script>
...
<script type="text/javascript" charset="utf-8">
    ...
    wx.ready(function () {
        var shareData = {
            title: '九人牛牛（房间号：<?php echo $room['room_num']; ?>）',
...
<script type="text/javascript">
    ...
    $(function () {
        $(".msg img.showmsgimg").click(function () {
            $(".msg ul").toggle();
        })
        $(".rule").click(function () {
        ...
        socket.on('new_msg', function (msg) {
            ...
            if(ret.type == 4) {
                ...
                if (ret.room.gamestatus >= 2 && ret.gamestatus > 0) {
                    ...
                    $('.readyimg').hide();
                    $('#gameready').hide();
                    poker.fanpaiall($('.cards .poker'), '__STATIC__/game/img/pai2/', ret.pai, function(){
                        mp3play('mp3fapai');
                    });
...
//显示抢庄倍数
                    ...
                    if (ret.data[i]['gamestatus'] > 0 && ret.room.gamestatus > 1) {
                        ...
                        poker.fanpaiall($('#player_' + i+' .poker'), '__STATIC__/game/img/pai2/', ret.data[i]['pai'],function(){
                            mp3play('mp3fapai');
                        });
                    }
