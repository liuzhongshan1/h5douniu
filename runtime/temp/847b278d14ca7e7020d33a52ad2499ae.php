<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"C:\phpStudy\WWW\douniu/application/admin\view\redbag\index.html";i:1500523426;s:61:"C:\phpStudy\WWW\douniu/application/admin\view\public\top.html";i:1499225308;s:62:"C:\phpStudy\WWW\douniu/application/admin\view\public\left.html";i:1500521692;s:64:"C:\phpStudy\WWW\douniu/application/admin\view\public\header.html";i:1499837462;s:64:"C:\phpStudy\WWW\douniu/application/admin\view\public\bottom.html";i:1499225308;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
      ...
      <header class="panel-heading">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo $vo['create_id']; ?></td>
            <td><?php echo getnickname($vo['create_id']); ?></td>
            <td><?php echo date('Y-m-d H:i:s',$vo['create_time']); ?></td>
            <td><?php echo $vo['receive_id']; ?></td>
            <td><?php echo date('Y-m-d H:i:s',$vo['receive_time']); ?></td>
              <td><?php echo $vo['cards_num']; ?></td>
              <td><?php if($vo['status'] == '0'): ?>未领取<?php endif; if($vo['status'] == '1'): ?>领取<?php endif; if($vo['status'] == '-1'): ?>退回<?php endif; ?>

              </td>
            <!--<td><a onClick="return confirm('您确定要删除吗？');" href="<?php echo url('delete', array('id' => $vo['id'])); ?>" class="btn btn-danger btn-sm">删除</a> <a href="<?php echo url('modify', array('id' => $vo['id'])); ?>" class="btn btn-success btn-sm">修改</a></td>-->
          </tr>
