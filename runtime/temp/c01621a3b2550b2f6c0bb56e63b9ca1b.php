<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"C:\phpStudy\WWW\douniu/application/admin\view\member\index.html";i:1500533916;s:61:"C:\phpStudy\WWW\douniu/application/admin\view\public\top.html";i:1499225308;s:62:"C:\phpStudy\WWW\douniu/application/admin\view\public\left.html";i:1500521692;s:64:"C:\phpStudy\WWW\douniu/application/admin\view\public\header.html";i:1499837462;s:64:"C:\phpStudy\WWW\douniu/application/admin\view\public\bottom.html";i:1499225308;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
  <meta charset="utf-8">
       ...
       <!--body wrapper start-->
        <div class="wrapper">
          ...
          <header class="panel-heading">
             ...
             <!--<a href="<?php echo url('add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus" ></i> 增加会员</a>-->
             </span>
            ...
            <div class="panel-body">
              ...
              <table class="table table-hover table-bordered">
                ...
                <tr>
                  ...
                  <td><?php echo $vo['cards']; ?></td>
                  <td><?php echo $vo['money']; ?></td>
                  <td><?php echo $vo['status']; ?></td>
                    <td><?php echo $vo['rate']; ?>%</td>
                  <td style="text-align:center; width:120px;"><a href="<?php echo url('delete', array('id' => $vo['id'])); ?>" class="btn btn-danger btn-sm">删除</a> <a href="<?php echo url('modify', array('id' => $vo['id'])); ?>" class="btn btn-success btn-sm">修改</a></td>
                </tr>
               <?php endforeach; endif; else: echo "" ;endif; ?>
              <tr>
                <td colspan="9" align="center"><?php echo $pages; ?></td>
              </tr>
          </tbody>
